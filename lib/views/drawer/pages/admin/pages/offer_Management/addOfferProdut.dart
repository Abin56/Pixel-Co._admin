...
import 'package:pixels_admin/controller/firebase/add_offerProduct.dart';
...
class AddOfferProducts extends StatelessWidget {
  ...
  AddOfferProducts({required this.imagepath, super.key});
                            ...
                            child: SizedBox(
                              ...
                              child: TextButton.icon(
                                onPressed: () async {
                                  ...
                                  final offerPrice =
                                      offerPercentageController.text.trim();
                                  ////////////////////////////
                                  if (productName.isNotEmpty &&
                                      price.isNotEmpty &&
                                      quantity.isNotEmpty &&
                                      discription.isNotEmpty) {
                                    final addtoFireBase = OfferManagementModel(
                                        ...
                                        available: true);
                                    await AddOfferProductToFireBase()
                                        .addOfferController(addtoFireBase);
                                  } else {
                                    return;
                                  }
                                },
