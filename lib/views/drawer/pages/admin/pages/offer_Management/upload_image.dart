...
import 'package:pixels_admin/views/drawer/pages/admin/pages/offer_Management/addOfferProdut.dart';
import 'package:pixels_admin/views/drawer/pages/admin/pages/product_Mangement/widget/add_product_details.dart';

class UploadImageScreenToOffer extends StatefulWidget {
  UploadImageScreenToOffer({super.key});

  @override
  State<UploadImageScreenToOffer> createState() =>
      _UploadImageScreenToOfferState();
}

class _UploadImageScreenToOfferState extends State<UploadImageScreenToOffer> {
